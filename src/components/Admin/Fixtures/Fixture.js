...
const Fixture = () => {
    ...
    const {addFixture, message, token} = useContext(DataContext)
            ...
            {token !== "" ? <div className="container">
                    <div className="d-flex justify-content-center mt-5 mb-5">
                        <div className="card px-5 py-3" style={{width: "30rem"}}>
                            <h2 className="text-center mb-4 mt-3">Add Fixtures</h2>
                            <form onSubmit={handleSubmit}>
                                ...
                                <div className="mb-3">
                                    <label htmlFor="home_score" className="form-label">Home Team Score</label>
                                    <input type="number" className="form-control" id="home_score"
                                           onChange={(e) => setHomeTeamScore(e.target.value)}
                                    />
                                </div>
                                <div className="mb-3">
                                    <label htmlFor="away_score" className="form-label">Away Team Score</label>
                                    <input type="number" className="form-control" id="away_score"
